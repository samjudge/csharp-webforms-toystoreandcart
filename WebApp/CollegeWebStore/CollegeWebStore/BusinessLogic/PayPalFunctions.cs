...
public class NVPAPICaller
{
    ...
    public string APIUsername = "SamTheLad";
    private string APIPassword = "NobodysBusiness";
    private string APISignature = "019o8f759AYyUz38";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (CollegeWebStore.BusinessLogic.BusCartLogic myCartOrders = new CollegeWebStore.BusinessLogic.BusCartLogic())
        {
